...
![Continuous Integration](https://github.com/hackariens/laravel/actions/workflows/ci.yml/badge.svg?branch=develop)
...
```sh
git clone --recursive git@github.com:hackariens/laravel.git laravel
cd laravel
```
