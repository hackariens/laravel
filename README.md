# Welcome to @koromerzhin/template-laravel 👋

![Version](https://img.shields.io/badge/version-1.0.0-blue.svg?cacheSeconds=2592000)
![Documentation](https://img.shields.io/badge/documentation-yes-brightgreen.svg)
[![Maintenance](https://img.shields.io/badge/Maintained%3F-yes-green.svg)](https://github.com/koromerzhin/template-laravel/graphs/commit-activity)
![Continuous Integration](https://github.com/koromerzhin/template-laravel/workflows/Continuous%20Integration/badge.svg?branch=develop)

> Templates pour la création d'un nouveau projet laravel

## 🏠 [Homepage](https://github.com/koromerzhin/template-laravel#readme)
...
Feel free to check
[issues page](https://github.com/koromerzhin/template-laravel/issues).
You can also take a look at the
[contributing guide](https://github.com/koromerzhin/template-laravel/blob/develop/CONTRIBUTING.md).
...
This project is
[MIT](https://github.com/koromerzhin/template-laravel/blob/develop/LICENSE) licensed.
